...
class bert_headtoken_model(nn.Module):
    ...
    def forward(self,head_token,nlp_state,act_type,attention_mask=None):
        ...
        if attention_mask==None:
            h1 = self.bert_backbone(nlp_state,head_token)
        else:
            h1 = self.bert_backbone(nlp_state,head_token,attention_mask=attention_mask)
